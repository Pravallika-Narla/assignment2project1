...
1)) manfufacture='create table  manufacture (manufacture_id INT PRIMARY KEY,product_name VARCHAR(50) NOT NULL,color VARCHAR(20) NOT NULL,number_of_items INT NOT NULL, date_of_manufacture DATE NOT NULL, defective_item BOOLEAN NOT NULL)'
 cur.execute(manufacture)
 goods='CREATE TABLE goods (goods_id INT PRIMARY KEY,product_name VARCHAR(50) NOT NULL, color VARCHAR(20) NOT NULL,number_of_items INT NOT NULL,date_of_manufacture DATE NOT NULL, price DECIMAL(10,2) NOT NULL, discount DECIMAL(3,2) NOT NULL)'
 cur.execute(goods) 
 purchase_table ="CREATE TABLE purchase ( purchase_id INT PRIMARY KEY,product_name VARCHAR(50) NOT NULL, color VARCHAR(20) NOT NULL,number_of_items INT NOT NULL,date_of_purchase DATE NOT NULL, store_name VARCHAR(50) NOT NULL,purchase_amount DECIMAL(10,2) NOT NULL)"
 cur.execute(purchase_table) 
 sales_table ="CREATE TABLE sale (sale_id INT PRIMARY KEY,product_name VARCHAR(50) NOT NULL,color VARCHAR(20) NOT NULL, number_of_items INT NOT NULL,date_of_sale DATE NOT NULL,  store_name VARCHAR(50) NOT NULL, selling_price DECIMAL(10,2) NOT NULL,profit_margin DECIMAL(3,2) NOT NULL)"
 cur.execute(sales_table)
 #Insert multiple entries to these different tables - “manufacture”, “goods”, “purchase” and “sale”.
2)) insert_into_manufacture ="INSERT INTO manufacture (manufacture_id, product_name, color, number_of_items, date_of_manufacture, defective_item)VALUES (1, 'Wooden Chair', 'Brown', 50, '2022-12-01', 0),(2, 'Wooden Table', 'Brown', 20, '2023-01-05', 0),(3, 'Red Toy Car', 'Red', 100, '2023-02-10', 0),(4, 'Blue Toy Car', 'Blue', 50, '2023-03-15', 1),(5, 'White T-Shirt', 'White', 200, '2023-04-20',0),(6, 'Black T-Shirt', 'Black', 150, '2023-04-25', 0),(7, 'Red Toy Car', 'Red', 50, '2023-05-01', 0)"
cur.execute(insert_into_manufacture) 
